...
REST API for the Renenutet project built with Fastify, Prisma, and TypeScript.

---

## @57em-regiment/renenutet-api-contract
...
```bash
pnpm add @57em-regiment/renenutet-api-contract @ts-rest/core
# or
npm install @57em-regiment/renenutet-api-contract
```
...
import { contract } from '@57em-regiment/renenutet-api-contract';
...
```bash
pnpm add @57em-regiment/renenutet-api-contract@beta
```
